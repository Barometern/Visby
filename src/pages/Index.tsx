...
const Index = () => {
  ...
  return (
    <div className="relative bg-[#F2E8D5] text-[#2C1A0E]">
      <div
        className="pointer-events-none absolute inset-0 z-[5]"
        style={{
          background:
            "linear-gradient(180deg, rgba(12,8,5,0.12) 0%, rgba(12,8,5,0.1) 22%, rgba(12,8,5,0.08) 46%, rgba(12,8,5,0.06) 70%, rgba(12,8,5,0.04) 100%)",
        }}
      />

      {/* ─── SECTION 1 — CINEMATIC HERO ─── */}
      <section
        className="relative z-[2] flex min-h-screen flex-col overflow-hidden"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(180deg, rgba(12,8,5,0.12), rgba(12,8,5,0.22)), url(${heroImage})`,
            backgroundSize: "cover",
        ...
        {/* Bottom dissolve — extends deeper into section 2 */}
        <div
          className="pointer-events-none absolute bottom-[-90px] left-0 right-0 z-[8] h-[260px] sm:bottom-[-240px] sm:h-[560px]"
        >
          <div
            className="h-full w-full sm:hidden"
            style={{
              background:
                "linear-gradient(to bottom, transparent 0%, rgba(242,232,213,0.05) 26%, rgba(242,232,213,0.16) 54%, rgba(242,232,213,0.24) 74%, rgba(242,232,213,0.08) 92%, rgba(242,232,213,0) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent 0%, rgba(242,232,213,0.04) 18%, rgba(242,232,213,0.12) 34%, rgba(242,232,213,0.24) 50%, rgba(242,232,213,0.42) 64%, rgba(242,232,213,0.58) 76%, rgba(242,232,213,0.52) 84%, rgba(242,232,213,0.28) 92%, rgba(242,232,213,0.08) 97%, rgba(242,232,213,0) 100%)",
            }}
          />
        </div>
      ...
      <section
        id="how-it-works"
        className="relative z-[2] -mt-16 bg-[#F2E8D5] px-4 py-16 sm:px-6 lg:px-8 lg:py-20"
        style={{
          backgroundImage: `url(${parchmentBg})`,
          backgroundSize: "cover",
          backgroundPosition: "center -35px",
      ...
      >
        <div className="pointer-events-none absolute inset-0 z-[2] bg-[rgba(12,8,5,0.12)]" />
